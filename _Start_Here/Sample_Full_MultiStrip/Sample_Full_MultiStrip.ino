/*
 * Wired Wizards 2017 LED example code FULL POWER TIMES FOUR!
 * by Benjamin Davis
 * 
...
LedStrip inky = LedStrip(32, 4, NEO_GRB + NEO_KHZ800); 
LedStrip blinky = LedStrip(32, 5, NEO_GRB + NEO_KHZ800); 
LedStrip pinky = LedStrip(32, 6, NEO_GRB + NEO_KHZ800);
LedStrip clyde = LedStrip(32, 7, NEO_GRB + NEO_KHZ800); // you know we wouldn't leave blinky without his friends?
...
void loop() {
  ...
  switch (animationID){
    ...
    case AnimationType::fade:
      ...
      pinky.fade(red, green, blue, 2000);
      inky.fade(red, green, blue, 2000);
      clyde.fade(red, green, blue, 2000);
      break;
