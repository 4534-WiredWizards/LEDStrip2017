...
AnimationType animationID = AnimationType::groupScroll; //creates animationID, which will store what animation we are running, and sets it to solidColor.
...
void loop() {
  ...
  switch (animationID){
    ...
    case AnimationType::fade:
      blinky.fade(red, green, blue, 12);
      break;

    case AnimationType::alternatingFade:
      blinky.alternatingFade(red, green, blue, 5, 4);
      break;

    case AnimationType::wave:
      blinky.wave(red, green, blue, 20, 5, 12);
      break;
    ...
    case AnimationType::carnival:
      blinky.carnival(red, green, blue, 50);
      break;
    ...
    case AnimationType::groupScroll:
      blinky.groupScroll(red, green, blue, 20, 6, 12);
      break;
